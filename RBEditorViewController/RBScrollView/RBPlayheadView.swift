...
public protocol RBPlayheadViewDelegate: class {
  ...
  func playheadView(_ playheadView: RBPlayheadView, didPan panGestureRecognizer: UIPanGestureRecognizer)
}

public enum RBPlayheadShape {
...
public class RBPlayheadView: UIView {
  ...
  public weak var delegate: RBPlayheadViewDelegate?
